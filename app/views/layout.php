...
<head>
    ...
    <title>Портал Новостей. Добро Пожаловать!</title>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="/user/login" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Ваш Email:</label>
                        <div class="col-sm-5">
                            <input type="email" class="form-control" name="email" id="inputEmail3" placeholder="Email">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-offset-2 col-sm-2 control-label">Ваш пароль:</label>
                        <div class="col-sm-5">
